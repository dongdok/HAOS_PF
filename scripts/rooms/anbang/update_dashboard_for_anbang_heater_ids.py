...
def walk(node):
    if isinstance(node, dict):
        ...
        if entity_id == "switch.jubang_ac_heating_plug":
            node["entity"] = "switch.anbang_heater_plug"
...
async def main():
    ...
    async with websockets.connect(ws_url) as ws:
        ...
        Path("lovelace_pre_anbang_heater_dashboard_update.json").write_text(
        ...
        print("Updated dashboard heater references.")
